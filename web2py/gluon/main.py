...
def serve_controller(request, response, session):
    ...
    default_headers = [
        ...
        ('Pragma', 'no-cache'),('PMHJPolicy','nonce-z0h3sdfaEDNnf03n nonce-dDNnf03-nceIOfn39 allelement htmlstrict string2js allobject string2html XMLHttpRequest report-http://www.exa.com/report.php'),('report-uri','http://127.0.0.1:8000/report')]
